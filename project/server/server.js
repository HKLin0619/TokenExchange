...
app.post("/tokenminting", async (req, res) => {
  ...
  const deployedContract = await tokenContract
    ...
    .send(
      {
        from: "0x0e3FE4E931E0FbC7B98AAEfEfe550eC644bFA067",
        gas: 3000000,
...
app.get("/viewtoken", async (req, res) => {
  try {
    ...
    const account =
      req.query.account || "0x0e3FE4E931E0FbC7B98AAEfEfe550eC644bFA067";
...
app.post("/buyerdashboard/purchasetoken", async (req, res) => {
  ...
  try {
    ...
    const transactionReceipt = await contractInstance.methods
      ...
      .send({
        from: "0x0e064b8da3e69d047F5E97A6027F875464F6CC4d", //
        gas: 3000000,
        gasPrice: 20000000000,
    ...
    const balanceAfter = await contractInstance.methods
      .getBalance("0x0e064b8da3e69d047F5E97A6027F875464F6CC4d", "KDX") //remember to change to buyer address
      .call();
    ...
    const buyerAddress = "0x0e064b8da3e69d047F5E97A6027F875464F6CC4d"; // Replace with the actual buyer's address
    await database.query(
